...
function start() {
    ...
    score = 0;
    setInterval(() => {
        var ex = parseInt(window.getComputedStyle(enemy, null).getPropertyValue("left"));
        var ey = parseInt(window.getComputedStyle(enemy, null).getPropertyValue("top"));
        var cx = parseInt(window.getComputedStyle(c, null).getPropertyValue("left"));
